  ...
  <div class="container-fluid">
    <div class="card shadow-lg border-0 rounded-lg">
      <div class="card-header bg-primary text-white">
        <h5 class="mb-3"><i class="fa fa-cutlery mr-2"></i> <?= $title ?></h5>
      </div>
      <div class="card-body">
        <a href="<?= base_url('makanan/tambah') ?>" class="btn btn-success mb-4">
          <i class="fa fa-plus-circle"></i> Tambah Makanan Baru
        </a>
          ...
          <table class="table table-striped table-hover table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="<?= site_url('makanan/edit/'.$item->id_makanan) ?>" class="btn btn-warning btn-sm">
                    <i class="fa fa-edit"></i> Edit
                  </a>
                  <a href="<?= site_url('makanan/hapus/'.$item->id_makanan) ?>" class="btn btn-danger btn-sm"
                    onclick="return confirm('Anda yakin ingin menghapus makanan ini?')">
